      ...
      <div className="flex gap-2 items-center justify-center text-center">
        <Link href="mailto:anibiseun@gmail.com">
          <button className="p-[2px] relative">
            ...
            <div className="px-4 py-2  sm:px-4 sm:py-3 flex items-center gap-1 text-center bg-black text-xl sm:text-2xl cursor-pointer font-extrabold rounded-[6px] text-[#64ffda] hover:bg-[#233554]  relative group transition duration-200">
